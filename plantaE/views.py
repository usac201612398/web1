...
def guardar_pedido(request):
    ...
    for i in mensaje:
        ...
        pedidos.objects.create(fecha=today,fechapedido=i[6],cliente=i[5],cultivo=i[2],cantidad=i[4],encargado=i[7],itemsapcode=i[0],itemsapname=i[1],precio=datos.precio,total=datos.precio*i[4],orden=datos.orden)
