...
def procesarrecepcion(request):
    ...
    for i in mensaje:
        ...
        detallerecaux.objects.create(recepcion=i[1],fecha=detallerec.fecha,finca=i[3],cultivo=i[4],cajas=i[5],libras=i[6],status="En proceso",observaciones=i[8],llave=ref.llave,criterio=ref.criterio)
