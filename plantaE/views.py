...
def plantaEhomepageger(request):
    return render(request,'plantaE/plantaE_homeGerencial.html')
...
def poraprovechamientosger(request):
    ...
    return render(request, 'plantaE/salidasFruta_aprovechamientosger.html', {
        'registros': resultado,
        'tabla_html': tabla_html,
        'registros_json': registros_json,
    })
def poraprovechamientosempger(request):
    ...
    return render(request, 'plantaE/salidasFruta_aprovechamientosempger.html', {
        'registros': resultado,
        'tabla_html': tabla_html,
        'registros_json': registros_json,
    })
...
def guardar_pedido(request):
    ...
    for i in mensaje:
        ...
        pedidos.objects.create(fecha=today,fechapedido=i[6],cliente=i[5],cultivo=i[2],categoria=datos.categoria,cantidad=i[4],encargado=i[7],itemsapcode=i[0],itemsapname=i[1],precio=datos.precio,total=datos.precio*i[4],orden=datos.orden)
