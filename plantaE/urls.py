...
#    path('logout/', views.logout_view, name='logout'),
    ...
    path('inventarioProd/packinglist/<int:pk>/edit/', views.packinglist_update, name='inventarioProd_packinglist_update'),
    path('inventarioProd/packinglist/<int:pk>/delete/', views.packinglist_delete, name='inventarioProd_packinglist_delete'),
