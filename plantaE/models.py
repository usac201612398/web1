...
class supervisionproduccion(models.Model):
...
class controlcajas(models.Model):
    ...
    tipodecaja = models.CharField(max_length=100, blank=True, null=True)
    ...
    movimiento_ref = models.BigIntegerField(blank=True, null=True, db_index=True)
...
class productoTerm(models.Model):
    ...
    updated_at = models.DateTimeField(auto_now=True, blank=True, null=True)
    orden= models.CharField(max_length=30, blank=True, null=True)
    orden2= models.CharField(max_length=30, blank=True, null=True)
