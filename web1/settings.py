...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.path.join(Path(__file__).resolve().parent.parent, 'logs', 'django_debug.log'),  # Ruta del archivo de log
            'formatter': 'verbose',
        },
    },
    'loggers': {
        ...
        'myapp': {  # Configuración del logger para tu aplicación
            'handlers': ['console', 'file'],
            'level': 'DEBUG',
            'propagate': False,
        },
