...
class lotesForm(forms.ModelForm):
    ...
    plantas_padre = forms.FloatField(widget=forms.NumberInput(attrs={'class': 'my-input'}))  
    plantas_madre = forms.FloatField(widget=forms.NumberInput(attrs={'class': 'my-input'})) 
