...
def exportar_excel_generico(request, nombre_modelo):
    ...
    EXPORT_FIELDS = {
        ...
        'floresabiertas': ['codigo_lote', 'operario_name','codigo_empleado','supervisor_name','ubicacion_lote','estructura','apodo_variedad','tipo_cultivo','fecha','diasemana','nsemana','flores_abiertas','flores_anteras','flores_polinizadas','flores_sinpistilo','flores_viejas','boton_pequeño','status','observaciones'],
