...
class conteofrutosplanilla(models.Model):
    ...
    tipo_cultivo = models.CharField(max_length= 20, blank = True, null =  True)
    estructura = models.CharField(max_length= 50, blank = True, null =  True)
    cama1 = models.FloatField(blank = True, null = True) # Frutos/cama
    cama2 = models.FloatField(blank = True, null = True) # Frutos/cama
    cama3 = models.FloatField(blank = True, null = True) # Frutos/cama
    cama4 = models.FloatField(blank = True, null = True) # Frutos/cama
    cama5 = models.FloatField(blank = True, null = True) # Frutos/cama
    media = models.FloatField(blank = True, null = True) # Frutos/cama
...
class cosecha(models.Model):
    ...
    tipo_cultivo = models.CharField(max_length= 20, blank = True, null =  True)
    codigo_lote = models.BigIntegerField(blank=True, null=True)
    codigo_variedad  = models.CharField(max_length= 50, blank = True, null =  True)
    ...
    genero = models.CharField(max_length= 50, blank = True, null =  True)
    nsemana = models.IntegerField(blank = True, null = True)
    iniciosemana = models.DateField(blank=True, null=True)
    finsemana = models.DateField(blank=True, null=True)
    tipocajas = models.CharField(max_length= 20, blank = True, null =  True)
    cajas = models.IntegerField(blank = True, null =  True)
    extraccion = models.CharField(max_length= 20, blank = True, null =  True)
    desinfeccion = models.CharField(max_length= 20, blank = True, null =  True)
    kg_producidos = models.FloatField(blank = True, null = True)
    semillasxfruto = models.FloatField(blank = True, null = True)
    semillasxgramo = models.FloatField(blank = True, null = True)
    por_germ_enpapel = models.FloatField(blank = True, null = True)
    por_germ_enbandeja = models.FloatField(blank = True, null = True)
    created = models.DateTimeField(auto_now_add=True, blank=True, null=True)
    updated_at = models.DateTimeField(auto_now=True, blank=True, null=True)
    observaciones = models.CharField(max_length= 75, blank = True, null =  True)
    status = models.CharField(max_length= 30, blank = True, null =  True)
